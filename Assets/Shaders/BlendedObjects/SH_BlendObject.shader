Shader "RP/Blend Object"
{
  ...
  _WorkflowMode("WorkflowMode", Float) = 1.0
        ...
        _SSS_Power("Power", Float) = 2.1
        _SSS_Distortion("Distortion", Float) = 1.4
        _SSS_Scale("Scale", Float) = 10.0
        [HDR]_SSS_Color("Transmission Color", Color) = (1,1,1,1)
        ...
        _DetailNormalMapScale("Scale", Range(0.0, 4.0)) = 1.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // #include "Assets/GaneshaStudio/Shaders/UberShader/UberSurfaceInput.hlsl"
            // #include "Assets/GaneshaStudio/Shaders/UberShader/UberLitPass.hlsl"
            #define SURFACE_SHADER
            #define VERTEX_SHADER_MOD
            #define SHADING_UNITY_PBR
            #include "Assets/Shaders/BlendedObjects/BlendObject.hlsl"
